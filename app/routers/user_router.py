...
@router.get("/{user_id}/get-profile", response_model=UserResponseSchema)
...
@router.patch("/{user_id}/update-profile", response_model=UserResponseSchema)
